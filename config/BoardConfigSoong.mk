...
ifneq ($(TARGET_CAMERA_SERVICE_EXT_LIB),)
    $(error TARGET_CAMERA_SERVICE_EXT_LIB is deprecated, please migrate to soong_config_set,camera,ext_lib)
endif
...
ifneq ($(TARGET_HAS_MTK_SURFACEFLINGER),)
    $(error TARGET_HAS_MTK_SURFACEFLINGER is deprecated, please migrate to soong_config_set,surfaceflinger,has_mtk_surfaceflinger)
endif
